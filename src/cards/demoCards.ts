...
export const DEMO_CARDS: CardDefinition[] = [
  ...
  { id: 'CS2_121', type: CardType.MINION, cardClass: CardClass.NEUTRAL, cost: 2, rarity: Rarity.COMMON, collectible: true, attack: 2, health: 2, descriptions: { 'enUS': 'Taunt', 'zhCN': '嘲讽' } },
  ...
  { id: 'CS2_124', type: CardType.MINION, cardClass: CardClass.NEUTRAL, cost: 4, rarity: Rarity.COMMON, collectible: true, attack: 3, health: 5, descriptions: { 'enUS': 'Taunt', 'zhCN': '嘲讽' } },
  ...
  { id: 'CS2_141', type: CardType.MINION, cardClass: CardClass.NEUTRAL, cost: 3, rarity: Rarity.COMMON, collectible: true, attack: 3, health: 3, race: Race.BEAST, descriptions: { 'enUS': 'Taunt', 'zhCN': '嘲讽' } },
  ...
  { id: 'CS2_203', type: CardType.MINION, cardClass: CardClass.NEUTRAL, cost: 3, rarity: Rarity.COMMON, collectible: true, attack: 1, health: 4, race: Race.BEAST, descriptions: { 'enUS': 'Taunt', 'zhCN': '嘲讽' } },
  ...
  { id: 'CS1_042', type: CardType.MINION, cardClass: CardClass.NEUTRAL, cost: 2, rarity: Rarity.COMMON, collectible: true, attack: 2, health: 3, race: Race.BEAST, descriptions: { 'enUS': 'Taunt', 'zhCN': '嘲讽' } },
